<template>
  ...
  <transition-group name="list-complete" tag="p">
    ...
    <li class="tag-input list-complete-item" key="tag-input">
      <input type="text" ref="input" class="tag-input-inner" name="tag" v-model="name" @keyup.space.prevent="checkAndAdd" autocomplete="off" autofocus="on" @keyup="validateKeyStroke" @keydown="select" @keyup.delete="removeLastItem">
